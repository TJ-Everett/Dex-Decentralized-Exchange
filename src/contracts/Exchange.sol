...
contract Exchange {
	...
	address constant ETHER = address(0); //store Ether in tokens mappin with blank address
	...
	function depositToken(address _token, uint256 _amount) public {
		...
		//Manage Deposits - Update Balance - Emit event 
	}
	...
	function cancelOrder(uint256 _id) public {
		...
		require(_order.id == _id);// Must be valid order 
	...
	function _trade(uint256 _orderId, address _user, address _tokenGet, uint256 _amountGet, address _tokenGive, uint256 _amountGive) internal {
		...
		//Fee is deducted from _amountGet a.k.a the amount reveived 
